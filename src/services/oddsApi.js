...
export const oddsApi = {
  getSports: () => axios.get(`${BASE_URL}/sports`, { params: { apiKey: API_KEY } }),
  getOdds: (sport = 'soccer_fifa_world_cup', regions = 'us,uk', markets = 'h2h') =>
    axios.get(`${BASE_URL}/sports/${sport}/odds`, { params: { apiKey: API_KEY, regions, markets, oddsFormat: 'decimal' } }),
  ...
  getEventOdds: (sport, eventId, markets = 'h2h') =>
    axios.get(`${BASE_URL}/sports/${sport}/events/${eventId}/odds`, { params: { apiKey: API_KEY, markets, oddsFormat: 'decimal' } }),
};
