  ...
  return (
    ...
    >
      ...
      <div className="px-5 py-3">
        {wc.hasFullData ? (
          <Link to={wc.detailRoute} className="inline-flex items-center gap-1.5 text-xs font-medium text-wcGreen hover:underline">
            Full Poisson analysis & match data →
          </Link>
        ) : hasApiData ? (
          <div className="text-2xs text-blue-400">{liveMatches.length} matches loaded from football-data.org</div>
        ) : (
