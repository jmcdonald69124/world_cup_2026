...
export const WC2022_MATCHES = [
  ...
  { id: 'A5', round: 'Group', group: 'A', date: '2022-11-29', home: 'ECU', away: 'SEN', score: { home: 1, away: 2 }, venue: 'Khalifa International Stadium', city: 'Doha',
    scorers: [{ team: 'ECU', player: 'Moisés Caicedo', minute: 67 }, { team: 'SEN', player: 'Ismaîla Sarr', minute: 44 }, { team: 'SEN', player: 'Kalidou Koulibaly', minute: 70 }] },
  ...
  { id: 'F4', round: 'Group', group: 'F', date: '2022-11-27', home: 'CRO', away: 'CAN', score: { home: 4, away: 1 }, venue: 'Khalifa International Stadium', city: 'Doha',
    scorers: [{ team: 'CAN', player: 'Alphonso Davies', minute: 2 }, { team: 'CRO', player: 'Andrej Krамarić', minute: 36 }, { team: 'CRO', player: 'Marko Livaja', minute: 44 }, { team: 'CRO', player: 'Lovro Majer', minute: 70 }, { team: 'CRO', player: 'Andrej Krамarić', minute: 74 }] },
