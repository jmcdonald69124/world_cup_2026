...
// Historical WC goal distribution by 5-minute buckets (approximate)
const DEFAULT_DATA = [
  { minute: '0-5', count: 45 },
  { minute: '6-10', count: 52 },
  { minute: '11-15', count: 61 },
  { minute: '16-20', count: 58 },
  { minute: '21-25', count: 63 },
  { minute: '26-30', count: 70 },
  { minute: '31-35', count: 72 },
  { minute: '36-40', count: 75 },
  { minute: '41-45', count: 88 },
  { minute: '45+', count: 55 },
  { minute: '46-50', count: 64 },
  { minute: '51-55', count: 69 },
  { minute: '56-60', count: 73 },
  { minute: '61-65', count: 78 },
  { minute: '66-70', count: 80 },
  { minute: '71-75', count: 82 },
  { minute: '76-80', count: 85 },
  { minute: '81-85', count: 90 },
  { minute: '86-90', count: 95 },
  { minute: '90+', count: 68 },
];
...
export default function GoalDistribution({ data }) {
  ...
  useEffect(() => {
    ...
    const xScale = d3.scaleBand()
      .domain(chartData.map(d => d.minute))
      .range([0, innerWidth])
      .padding(0.1);
    ...
    g.selectAll('.bar')
      ...
      .on('mouseover', function (e, d) {
        ...
        tooltip
          .style('opacity', 1)
          .html(`<strong>${d.minute} min</strong><br/>${d.count} goals`)
    ...
    chartData.forEach((d, i) => {
      if (i % 2 === 0) {
        g.append('text')
          .attr('x', xScale(d.minute) + xScale.bandwidth() / 2)
