...
export const WC2022_MATCHES = [
  ...
  { id: 'B1', round: 'Group', group: 'B', date: '2022-11-21', home: 'ENG', away: 'IRN', score: { home: 6, away: 2 }, venue: 'Khalifa International Stadium', city: 'Doha',
    scorers: [{ team: 'ENG', player: 'Bukayo Saka', minute: 35 }, { team: 'ENG', player: 'Mehdi Taremi', minute: 65 }, { team: 'ENG', player: 'Jude Bellingham', minute: 35 }, { team: 'ENG', player: 'Bukayo Saka', minute: 43 }, { team: 'ENG', player: 'Raheem Sterling', minute: 45 }, { team: 'ENG', player: 'Jack Grealish', minute: 62 }, { team: 'ENG', player: 'Marcus Rashford', minute: 71 }, { team: 'IRN', player: 'Mehdi Taremi', minute: 90 }] },
  ...
  { id: 'D4', round: 'Group', group: 'D', date: '2022-11-26', home: 'FRA', away: 'DEN', score: { home: 2, away: 1 }, venue: 'Stadium 974', city: 'Doha',
    scorers: [{ team: 'DEN', player: 'Andreas Christensen', minute: 68 }, { team: 'FRA', player: 'Kylian Mbappé', minute: 61 }, { team: 'FRA', player: 'Kylian Mbappé', minute: 86 }] },
  ...
  { id: 'E4', round: 'Group', group: 'E', date: '2022-11-27', home: 'ESP', away: 'GER', score: { home: 1, away: 1 }, venue: 'Al Bayt Stadium', city: 'Al Khor',
    scorers: [{ team: 'GER', player: 'Álvaro Morata', minute: 62 }, { team: 'ESP', player: 'Álvaro Morata', minute: 62 }, { team: 'GER', player: 'Niclas Füllkrug', minute: 83 }] },
  ...
  { id: 'E6', round: 'Group', group: 'E', date: '2022-12-01', home: 'CRC', away: 'GER', score: { home: 2, away: 4 }, venue: 'Al Bayt Stadium', city: 'Al Khor',
    scorers: [{ team: 'CRC', player: 'Juan Pablo Vargas', minute: 58 }, { team: 'CRC', player: 'Yeltsin Tejeda', minute: 70 }, { team: 'GER', player: 'Serge Gnabry', minute: 10 }, { team: 'GER', player: 'Kai Havertz', minute: 62 }, { team: 'GER', player: 'Kai Havertz', minute: 73 }, { team: 'GER', player: 'Niclas Füllkrug', minute: 89 }] },
  ...
  { id: 'F4', round: 'Group', group: 'F', date: '2022-11-27', home: 'CRO', away: 'CAN', score: { home: 4, away: 1 }, venue: 'Khalifa International Stadium', city: 'Doha',
    scorers: [{ team: 'CAN', player: 'Alphonso Davies', minute: 2 }, { team: 'CRO', player: 'Andrej Kramarić', minute: 36 }, { team: 'CRO', player: 'Marko Livaja', minute: 44 }, { team: 'CRO', player: 'Lovro Majer', minute: 70 }, { team: 'CRO', player: 'Andrej Kramarić', minute: 74 }] },
  ...
  { id: 'F6', round: 'Group', group: 'F', date: '2022-12-01', home: 'CAN', away: 'MAR', score: { home: 1, away: 2 }, venue: 'Al Thumama Stadium', city: 'Doha',
    scorers: [{ team: 'CAN', player: 'Nayef Aguerd (OG)', minute: 40 }, { team: 'MAR', player: 'Hakim Ziyech', minute: 4 }, { team: 'MAR', player: 'Youssef En-Nesyri', minute: 23 }] },
  ...
  { id: 'G3', round: 'Group', group: 'G', date: '2022-11-28', home: 'CMR', away: 'SRB', score: { home: 3, away: 3 }, venue: 'Al Janoub Stadium', city: 'Al Wakrah',
    scorers: [{ team: 'SRB', player: 'Strahinja Pavlović', minute: 26 }, { team: 'SRB', player: 'Sergej Milinković-Savić', minute: 44 }, { team: 'CMR', player: 'Jean-Charles Castelletto', minute: 29 }, { team: 'CMR', player: 'Vincent Aboubakar', minute: 63 }, { team: 'CMR', player: 'Eric Maxim Choupo-Moting', minute: 66 }, { team: 'SRB', player: 'Luka Jović', minute: 44 }] },
  ...
  { id: 'G5', round: 'Group', group: 'G', date: '2022-12-02', home: 'SRB', away: 'SUI', score: { home: 2, away: 3 }, venue: 'Stadium 974', city: 'Doha',
    scorers: [{ team: 'SRB', player: 'Aleksandar Mitrović', minute: 26 }, { team: 'SRB', player: 'Dušan Tadic', minute: 35 }, { team: 'SUI', player: 'Xherdan Shaqiri', minute: 20 }, { team: 'SUI', player: 'Breel Embolo', minute: 44 }, { team: 'SUI', player: 'Remo Freuler', minute: 48 }] },
  ...
  { id: 'H3', round: 'Group', group: 'H', date: '2022-11-28', home: 'KOR', away: 'GHA', score: { home: 2, away: 3 }, venue: 'Education City Stadium', city: 'Al Rayyan',
    scorers: [{ team: 'KOR', player: 'Cho Gue-sung', minute: 58 }, { team: 'KOR', player: 'Cho Gue-sung', minute: 61 }, { team: 'GHA', player: 'André Ayew', minute: 24 }, { team: 'GHA', player: 'Mohammed Kudus', minute: 34 }, { team: 'GHA', player: 'Mohammed Kudus', minute: 68 }] },
  ...
  { id: 'H6', round: 'Group', group: 'H', date: '2022-12-02', home: 'KOR', away: 'POR', score: { home: 2, away: 1 }, venue: 'Education City Stadium', city: 'Al Rayyan',
    scorers: [{ team: 'KOR', player: 'Kim Young-gwon', minute: 27 }, { team: 'KOR', player: 'Hwang Hee-chan', minute: 90 }, { team: 'POR', player: 'Ricardo Horta', minute: 7 }] },
  ...
  { id: 'R16_8', round: 'Round of 16', group: null, date: '2022-12-06', home: 'POR', away: 'SUI', score: { home: 6, away: 1 }, venue: 'Lusail Stadium', city: 'Lusail',
    scorers: [{ team: 'POR', player: 'Goncalo Ramos', minute: 17 }, { team: 'POR', player: 'Goncalo Ramos', minute: 51 }, { team: 'POR', player: 'Goncalo Ramos', minute: 55 }, { team: 'POR', player: 'Pepe', minute: 33 }, { team: 'POR', player: 'Raphaël Guerreiro', minute: 55 }, { team: 'POR', player: 'Rafael Leão', minute: 90 }, { team: 'SUI', player: 'Manuel Akanji', minute: 58 }] },
  ...
  { id: 'QF4', round: 'Quarterfinals', group: null, date: '2022-12-10', home: 'ENG', away: 'FRA', score: { home: 1, away: 2 }, venue: 'Al Bayt Stadium', city: 'Al Khor',
    scorers: [{ team: 'ENG', player: 'Bukayo Saka', minute: 50 }, { team: 'FRA', player: 'Aurélien Tchouaméni', minute: 17 }, { team: 'FRA', player: 'Olivier Giroud', minute: 78 }] },
  ...
  { id: 'TP', round: '3rd Place', group: null, date: '2022-12-17', home: 'CRO', away: 'MAR', score: { home: 2, away: 1 }, venue: 'Khalifa International Stadium', city: 'Doha',
    scorers: [{ team: 'MAR', player: 'Achraf Dari', minute: 9 }, { team: 'CRO', player: 'Joško Gvardiol', minute: 7 }, { team: 'CRO', player: 'Mislav Oršić', minute: 42 }] },
